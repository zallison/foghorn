...
docker-run: docker build
        ...
        docker run --name foghorn -v ${CONTAINER_DATA}:/foghorn/foghorn -d -p 53:5333/udp -p 53:5333/tcp -p 8053:8053/tcp -p 801:1801/tcp -v /etc/hosts:/etc/hosts:ro --restart unless-stopped  ${PREFIX}/${CONTAINER_NAME}:${TAG}
