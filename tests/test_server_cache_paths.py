...
def test_ensure_edns_does_not_add_opt_when_missing():
    """Brief: _ensure_edns does not add OPT when the client omits EDNS.

    Inputs:
      - None

    Outputs:
      - None; asserts no OPT is added without client EDNS.
    """
    ...
    # Case 1: dnssec_mode=ignore -> no OPT added
    ...
    # Case 2: dnssec_mode=validate -> still no OPT added
