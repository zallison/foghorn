"""
Brief: WHOIS-path and age-calculation edge-case tests for NewDomainFilterPlugin.
...
from foghorn.plugins.resolve.new_domain_filter import NewDomainFilterPlugin as NDF
