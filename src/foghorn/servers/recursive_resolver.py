...
fromfoghorn.servers.transports.tcp import tcp_query as _tcp_transport_query
fromfoghorn.servers.transports.udp import udp_query as _udp_transport_query
