...
class PostgresStatsStore(BaseStatsStore):
    ...
    def supports_query_log_clear(self) -> bool:
        """Brief: Return True because PostgreSQL backend supports filtered clears.
    ...
    def _append_optional_text_filter(
        ...
        *,
        ...
        Example:
            ``_append_optional_text_filter(raw, 'qtype', where=where, params=params,
            normalized=normalized, clause='qtype = %s', normalizer=str.upper)``
        """
